(function(global, factory) {
    ...
    OrientedBox.prototype.update = (function() {
        ...
        return function update() {
            ...
            this.invMatrix.copy(this.matrix).getInverse(this.invMatrix);
            this.needsUpdate = false;
    ...
    const intersectsGeometry = (function() {
        ...
        return function intersectsGeometry(nodeIndex32, geometry, otherGeometry, geometryToBvh, cachedObb = null) {
            ...
            if (isLeaf) {
                ...
                // here.
                invertedMat.copy(geometryToBvh).getInverse(invertedMat);
    ...
    class MeshBVH {
        ...
        bvhcast(otherBvh, matrixToLocal, callbacks) {
            ...
            tempMatrix.copy(matrixToLocal).getInverse(tempMatrix);
        ...
        closestPointToGeometry(otherGeometry, geometryToBvh, target1 = {}, target2 = {}, minThreshold = 0, maxThreshold = Infinity) {
            ...
            tempMatrix.copy(geometryToBvh).getInverse(tempMatrix);
